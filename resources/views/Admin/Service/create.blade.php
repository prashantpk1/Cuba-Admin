<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel1">{{ translate('add_service') }}</h5>
                    ...
                    <div class="row">
                        @foreach ($language as $lang)
                            <div class="col-md-3"> <!-- Each language gets its own column -->
                                ...
                                <!-- Service Name -->
                                <div class="mb-3">
                                    <label class="form-label" for="service">{{ translate('service_name') }}
                                ...
                                <!-- Description -->
                                <div class="mb-3">
                                    <label class="form-label" for="description">{{ translate('description') }} <span
                                            class="text-danger">*</span></label>
                                ...
                                <!-- Title 1 -->
                                <div class="mb-3">
                                    <label class="form-label" for="title_1">{{ translate('title_1') }} <span
                                            class="text-danger">*</span></label>
                                ...
                                <!-- Title 2 -->
                                <div class="mb-3">
                                    <label class="form-label" for="title_2">{{ translate('title_2') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_2') }}"
                                        name="{{ $lang['lang_code'] }}[title_2]">
                                </div>

                                <!-- Title 3 -->
                                <div class="mb-3">
                                    <label class="form-label" for="title_3">{{ translate('title_3') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_3') }}"
                                        name="{{ $lang['lang_code'] }}[title_3]">
                                </div>
                                ...
                                <!-- Description 1 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_1">{{ translate('description_1') }} <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_1') }}"
                                        name="{{ $lang['lang_code'] }}[description_1]"></textarea>
                                </div>

                                <!-- Description 2 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_2">{{ translate('description_2') }} <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_2') }}"
                                        name="{{ $lang['lang_code'] }}[description_2]"></textarea>
                                </div>

                                <!-- Description 3 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_3">{{ translate('description_3') }} <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_3') }}"
                                        name="{{ $lang['lang_code'] }}[description_3]"></textarea>
                                </div>
                                ...
                                <!-- Heading 1 -->
                                <div class="mb-3">
                                    <label class="form-label" for="heading_1">{{ translate('heading_1') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_heading_1') }}"
                                        name="{{ $lang['lang_code'] }}[heading_1]">
                                </div>

                                <!-- Title 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="title_4">{{ translate('title_4') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_4') }}"
                                        name="{{ $lang['lang_code'] }}[title_4]">
                                </div>

                                <!-- Title 5 -->
                                <div class="mb-3">
                                    <label class="form-label" for="title_5">{{ translate('title_5') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_5') }}"
                                        name="{{ $lang['lang_code'] }}[title_5]">
                                </div>

                                <!-- Title 6 -->
                                <div class="mb-3">
                                    <label class="form-label" for="title_6">{{ translate('title_6') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_6') }}"
                                        name="{{ $lang['lang_code'] }}[title_6]">
                                </div>

                                <!-- Title 7 -->
                                <div class="mb-3">
                                    <label class="form-label" for="title_7">{{ translate('title_7') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_7') }}"
                                        name="{{ $lang['lang_code'] }}[title_7]">
                                </div>

                                <!-- Description 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_4">{{ translate('description_4') }} <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_4') }}"
                                        name="{{ $lang['lang_code'] }}[description_4]"></textarea>
                                </div>

                                <!-- Description 5 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_5">{{ translate('description_5') }} <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_5') }}"
                                        name="{{ $lang['lang_code'] }}[description_5]"></textarea>
                                </div>

                                <!-- Description 6 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_6">{{ translate('description_6') }} <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_6') }}"
                                        name="{{ $lang['lang_code'] }}[description_6]"></textarea>
                                </div>
                                ...
                                <!-- Heading 2 -->
                                <div class="mb-3">
                                    <label class="form-label" for="heading_2">{{ translate('heading_2') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_heading_2') }}"
                                        name="{{ $lang['lang_code'] }}[heading_2]">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_8') }}"
                                        name="{{ $lang['lang_code'] }}[title_8]">
                                </div>

                                <!-- Description 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_8">{{ translate('description_8') }}
                                        ({{ $lang['lang_name'] }}) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_8') }}"
                                        name="{{ $lang['lang_code'] }}[description_8]"></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_9') }}"
                                        name="{{ $lang['lang_code'] }}[title_9]">
                                </div>

                                <!-- Description 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_9">{{ translate('description_9') }}
                                        ({{ $lang['lang_name'] }}) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_9') }}"
                                        name="{{ $lang['lang_code'] }}[description_9]"></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_10') }}"
                                        name="{{ $lang['lang_code'] }}[title_10]">
                                </div>

                                <!-- Description 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_10">{{ translate('description_10') }}
                                        ({{ $lang['lang_name'] }}) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_10') }}"
                                        name="{{ $lang['lang_code'] }}[description_10]"></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_11') }}"
                                        name="{{ $lang['lang_code'] }}[title_11]">
                                </div>

                                <!-- Description 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_11">{{ translate('description_11') }}
                                        ({{ $lang['lang_name'] }}) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_11') }}"
                                        name="{{ $lang['lang_code'] }}[description_11]"></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_12') }}"
                                        name="{{ $lang['lang_code'] }}[title_12]">
                                </div>

                                <!-- Description 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_12">{{ translate('description_12') }}
                                        ({{ $lang['lang_name'] }}) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_12') }}"
                                        name="{{ $lang['lang_code'] }}[description_12]"></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_13') }}"
                                        name="{{ $lang['lang_code'] }}[title_13]">
                                </div>

                                <!-- Description 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_13">{{ translate('description_13') }}
                                        ({{ $lang['lang_name'] }}) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_13') }}"
                                        name="{{ $lang['lang_code'] }}[description_13]"></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_14') }}"
                                        name="{{ $lang['lang_code'] }}[title_14]">
                                </div>

                                <!-- Description 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_14">{{ translate('description_14') }}
                                        ({{ $lang['lang_name'] }}) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_14') }}"
                                        name="{{ $lang['lang_code'] }}[description_14]"></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_15') }}"
                                        name="{{ $lang['lang_code'] }}[title_15]">
                                </div>

                                <!-- Description 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_15">{{ translate('description_15') }}
                                        ({{ $lang['lang_name'] }}) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_15') }}"
                                        name="{{ $lang['lang_code'] }}[description_15]"></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('enter_title_16') }}"
                                        name="{{ $lang['lang_code'] }}[title_16]">
                                </div>

                                <!-- Description 4 -->
                                <div class="mb-3">
                                    <label class="form-label" for="description_16">{{ translate('description_16') }}
                                        ({{ $lang['lang_name'] }}) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="{{ translate('enter_description_16') }}"
                                        name="{{ $lang['lang_code'] }}[description_16]"></textarea>
                                </div>
                                <hr>
                            </div>
                        @endforeach
