...
@section('content')
        ...
        <div class="page-title">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <h4>{{ translate('platform_language_setup') }}</h4>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="display  platform-language-data">
    ...
    <div class="modal fade" id="createmodel" tabindex="-1" role="dialog" aria-labelledby="createmodel"
        ...
        @include('Admin.Platform-Lang.create')
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('.platform-language-data').DataTable({
                ...
                ajax: "{{ route('platform-lang.index') }}",
            ...
            $(".platform-language-data").on('click', '.destroy-data', function(e) {
            ...
            $(".platform-language-data").on('click', '.status-change', function(e) {
            ...
            //add platform-lang submit

            $("#platform-lang-frm").submit(function(event) {
            ...
            //add platform-lang submit end





            //get platform-lang data for edit page

            $(".platform-language-data").on('click', '.edit-data', function(e) {
            ...
            //get platform-language-data data for edit page end





            //edit platform-language-data

            $(document).on('submit', '#platform-lang-edit-form', function(e) {
